...
CREATE SCHEMA IF NOT EXISTS `bettit` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `bettit` ;

-- -----------------------------------------------------
-- Table `bettit`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bettit`.`users` (
...
CREATE TABLE IF NOT EXISTS `bettit`.`events` (
  ...
  CONSTRAINT `fk_events_threads1`
    ...
    REFERENCES `bettit`.`threads` (`thread_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `bettit`.`outcomes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bettit`.`outcomes` (
  ...
  CONSTRAINT `fk_outcomes_events1`
    ...
    REFERENCES `bettit`.`events` (`event_id` , `thread_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- Table `bettit`.`bets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bettit`.`bets` (
  `username` VARCHAR(20) NOT NULL,
  ...
  CONSTRAINT `fk_users_has_outcomes_outcomes1`
    ...
    REFERENCES `bettit`.`outcomes` (`outcome_id` , `event_id` , `thread_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bettit`.`users_moderate_threads`
-- -----------------------------------------------------
